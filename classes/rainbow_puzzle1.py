...
class Rainbow_1(GameObject):
    ...
    def __init__(self, x: int, y: int):
        ...
        self.direction = [0, 0]
        self.speed = 150
        if Rainbow_1.rainbow_sprite is None:
            Rainbow_1.rainbow_sprite = pygame.image.load('img/candy_rainbow_wall.png').convert_alpha()
            #Rainbow.rainbow_sprite = pygame.mixer.Sound('/')
        super().__init__(x, y, 14, 14, Rainbow_1.rainbow_sprite, 'rainbow1')
    ...
    def push(self, horizontal: float, vertiacal: float, objects):
        ...
        for x in pygame.sprite.spritecollide(self, objects, dokill=False):
            ...
            if x.type == 'button_rainbow1':
                ...
                if open_the_trellis:
                    for x in GameObject.all_objects:
                        if x.type == 'trellis_rainbow1' and x.type == 'button_rainbow1':
                            x.kill()
